package org.owasp.oneliner.rest.securish;
 ...
 * Date: 2010-12-12
 */
@Path("/securish/oneliners")
@Component
public class OneLinerSecurishResource {
    private static final Log logger = LogFactory.getLog(OneLinerSecurishResource.class);
    ...
    /**
     * Example of restricting media type and using double submit anti-csrf cookie
     * @param nickName
     * @param oneLiners
     * @return
     */
    ...
    @CsrfProtection
    public Response putNewOneLiner(@CookieParam("nickNameSecurish") String nickName,
    ...
    /**
     * Example not restricting media type but at least using double submit
     * @param nickName
     * @param oneLinerJson
     * @return
     */
    @POST
    @CsrfProtection
    public Response putNewOneLinerText(@CookieParam("nickNameSecurish") String nickName,
                                       String oneLinerJson) {
        if(logger.isDebugEnabled()) { logger.debug("In putNewOneLinerText()"); }
        try {
